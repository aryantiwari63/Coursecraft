  ...
  return (
    ...
    <div className='w-full pt-10'>
        ...
        <div */} 
         ...
         <div
          className={`absolute md:static top-[100px] left-0 h-screen md:h-auto w-full md:w-auto bg-white md:bg-transparent p-8 md:p-0 flex flex-col md:flex-row gap-6 transform transition-transform duration-300 ease-in-out 
            ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}
        >
