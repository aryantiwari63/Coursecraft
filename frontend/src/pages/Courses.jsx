...
function  Courses() {
  ...
  return (
   <div className='bg-[rgb(89,175,99)] pt-8 pb-8'>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={itcourse }>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5'>
