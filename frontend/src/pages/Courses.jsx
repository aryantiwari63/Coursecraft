...
function  Courses() {
  ...
  return (
   <div className='bg-[rgb(89,175,99)] pt-8 pb-8'>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('It')} }>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('Health')}}>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('Language')}}>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('Business')}}>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('Management')}}>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('English')}}>
        <div className='h-[30px] w-[30px] pt-1'><img src={It}/></div>
        <div className=''>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('personal development')}}>
    ...
    <div className='flex bg-[rgb(255,255,255)] w-[180px] justify-between p-2 h-[90px] rounded-md py-5' onClick={()=>{itcourse('sales & marketing')}}>
        <div className='h-[30px] w-[30px] pt-1'><img src={It}/></div>
        <div className=''>
